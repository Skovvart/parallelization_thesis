...
To lessen the impact of this, the result of these functions is constrained to be no higher than 2 adding a constraint method.
...
Another interesting fact is that for age 35, the limited Alea.cuBase solution from intermediary states -24...+25 was also accurate down to the 7th decimal, and to the 10th decimal compared to the -62...+62 GPU version.
...
\caption{Comparison of reserve-output for ages 1, 15, 35, 50 and 80 using various implementations of GF810.\label{fig:gf810ages}}
\end{figure}
