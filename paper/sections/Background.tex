...
The method has many restrictions that apply and should primarily be of the form \lstinline$factor * delta(constant - variable)$ where $factor$ is the ``sudden shock'' that should happen when \lstinline$constant - variable = 0$.
