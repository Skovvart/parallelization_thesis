...
It is unlikely that the memory bandwidth is not saturated at higher kernel launch parameter configurations, so assuming that the typical use case includes hundreds of thousands of iterations per kernel launch, optimizing ILP may be a futile effort.
