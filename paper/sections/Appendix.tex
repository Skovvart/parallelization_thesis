...
%\begin{appendices}
  ...
  \includepdf[pages=1,angle=90,pagecommand={\section{GF810 result comparison}\label{app:gf810results}}, frame,scale=0.65]{sections/appendix/GF810_result_comparison.pdf}
  \includepdf[pages=1,pagecommand={\section{GF810 age 1}\label{app:gf810ageresults}}, scale=0.7]{sections/appendix/GF810-1.pdf}
  \includepdf[pages=1,pagecommand={\section*{GF810 age 15}}, scale=0.7]{sections/appendix/GF810-15.pdf}
  \includepdf[pages=1,pagecommand={\section*{GF810 age 35}}, scale=0.7]{sections/appendix/GF810-35.pdf}
  \includepdf[pages=1,pagecommand={\section*{GF810 age 50}}, scale=0.7]{sections/appendix/GF810-50.pdf}
  \includepdf[pages=1,pagecommand={\section*{GF810 age 80}}, scale=0.7]{sections/appendix/GF810-80.pdf}
%\end{appendices}
